...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    Page<Article> findByAuthor_usernameContainingOrTitleContainingOrBodyContainingOrTags_contentOrComments_author_usernameContainingOrComments_bodyContaining
            (String kw, String kw_, String kw__, String kw___, String kw____, String kw_____, Pageable pageable);
